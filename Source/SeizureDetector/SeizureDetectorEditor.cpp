...
#define EXPAND_BOUNDS opBounds = opBounds.getUnion(bounds)
    ...
    optionsPanelTitle = new Label("CDOptionsTitle", "Seizure Detector Additional Settings");
...
void SeizureDetectorEditor::buttonEvent(Button* button)
{
...
Visualizer* SeizureDetectorEditor::createNewCanvas()
{
    canvas = new SeizureDetectorCanvas(getProcessor());
    return canvas;
}

Component* SeizureDetectorEditor::getOptionsPanel()
{
...
void SeizureDetectorEditor::loadCustomParameters(XmlElement* xml)
{
    ...
    forEachXmlChildElementWithTagName(*xml, xmlNode, "VALUES")
    {
		...
		betaEditable->setText(xmlNode->getStringAttribute("betaGain", limitEditable->getText()), sendNotificationAsync);
		deltaEditable->setText(xmlNode->getStringAttribute("deltaGain", limitEditable->getText()), sendNotificationAsync);
...
SeizureDetectorCanvas::SeizureDetectorCanvas(GenericProcessor* n)
    : processor(n)
{
    editor = static_cast<SeizureDetectorEditor*>(processor->editor.get());
...
SeizureDetectorCanvas::~SeizureDetectorCanvas() {}

void SeizureDetectorCanvas::refreshState() {}
void SeizureDetectorCanvas::update() {}
void SeizureDetectorCanvas::refresh() {}
void SeizureDetectorCanvas::beginAnimation() {}
void SeizureDetectorCanvas::endAnimation() {}
void SeizureDetectorCanvas::setParameter(int, float) {}
void SeizureDetectorCanvas::setParameter(int, int, int, float) {}

void SeizureDetectorCanvas::paint(Graphics& g)
{
...
void SeizureDetectorCanvas::resized()
{
